    ...
    public class UnitTest1
    {
        ...
        public void Can_Paginate()
        {
            ...
            Mock<IProductRepository> mock =
                new Mock<IProductRepository>(); mock.Setup(m => m.Products).Returns(new Product[]
                {
                    new Product {ProductID = 1, Name = "P1"},
                    new Product {ProductID = 2, Name = "P2"},
                    new Product {ProductID = 3, Name = "P3"},
     ...
     Products.ToArray(); Assert.IsTrue(prodArray.Length == 2);
...
+ @"<a class=""btn btn-default"" href=""Page3"">3</a>",
        ...
        public class CartTests
        {
            ...
            public void Calculate_Cart_Total()
            {
                ...
                target.AddItem(p1, 1);
                target.AddItem(p2, 1);
                target.AddItem(p1, 3); decimal result = target.ComputeTotalValue();
                // Assert
